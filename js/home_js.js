...
//each迴圈 使用$.each方法遍歷返回的資料date
		...
		for (let i = 0; i < 4; i++) {
			...
			$(class_name).click(function () {
					...
					products[3].innerHTML = `<div id="fonts4">${data[i].product_name_3}<br>${data[i].product_price_3}</div>`
    ...
    <div class="product_top row  m-0 justify-content-left   product_list ">
                        ...
                        <div class="imgbox">
                            ...
                            <div class="detail_product row  product_list" style="background-image: url(../img/tea_menu/Refreshing_can_Sijichun.jpg) ">
                            </div>
                        </div>
                        <div class="productText">

                            <h2 class='margin-bottom'>阿里山金萱</h2>
                            <div class="blueline">
                                <h3 class='h3between'>金萱樹種特有的奶糖香
                                <h3 class='margin-bottom'>觸動味蕾的驚喜口感</h3>
                            </div>
                            <h2>NT.980</h2>
                        </div>
                    </div>
                    <div class="detail_pd_img mx-auto" style="background-image: url(../img/tea_menu/Refreshing_Sijichun.jpg)">
                    </div>
